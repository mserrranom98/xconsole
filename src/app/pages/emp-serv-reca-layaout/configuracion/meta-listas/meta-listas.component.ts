...
import { MetaListaSelect, MetaListaInsert, MetaListaDelete, MetaListaItemSelect, MetaListaItemSet, Listas } from '../../../../pages/pages-models/model-emp-serv-rec';
import { MetaListasService } from '../../../../pages/pages-services/serv-emp-serv-rec/meta-listas.services';
import { DatatableComponent } from '@swimlane/ngx-datatable';
import { ListasService } from '../../../../pages/pages-services/serv-emp-serv-rec/listas.services';
...
export class MetaListasComponent implements OnInit {
  ...
  validar(){
    ...
    let pattLetras = /^[a-zA-Z]*$/;
    let pattLetrasNumerosEspacios = /^[a-zA-ZñÑ0-9-:()áéíóúÁÉÍÓÚ\s]*$/;
